...
import { 
  Calculator, Clock, Brain, Target, CheckCircle, 
  X, Play, RotateCcw, Trophy, TrendingUp
} from "lucide-react";
...
export default function AptitudeTests() {
  ...
  const testTypes = [
    { 
      ...
      desc: "Math problems, data interpretation",
      time: 30,
    ...
    { 
      ...
      desc: "Patterns, sequences, puzzles",
      time: 25,
    ...
    { 
      ...
      desc: "Charts, graphs, tables analysis",
      time: 20,
  ...
  const startTest = async (type) => {
    ...
    try {
      let prompt = `Generate 15 ${type} aptitude questions suitable for Indian students and job seekers.`;
      ...
      if (type === "quantitative") {
        ...
        - Coding-Decoding
        - Logical Sequences`;
      } else if (type === "data_interpretation") {
        prompt += `
        Include questions on:
        - Bar Charts
        - Pie Charts
      ...
      setAnswers([]);
      setSelectedAnswer("");
      setTimeLeft(testTypes.find(t => t.id === type)?.time * 60 || 1800);
      setIsActive(true);
      setResults(null);
    } catch (error) {
  ...
  const completeTest = async () => {
    ...
    try {
      await Assessment.create({
        ...
        areas_to_improve: score < 60 ? ["Practice more questions", "Review basic concepts"] : [],
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Sharpen your quantitative and logical reasoning skills with AI-generated practice tests
          </p>
        </div>
