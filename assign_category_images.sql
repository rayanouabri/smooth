-- =====================================================
-- ASSIGNATION D'IMAGES PAR CATÉGORIE
-- =====================================================
-- Ce script assigne des images pertinentes à chaque cours
-- selon sa catégorie, en utilisant des images Unsplash
-- =====================================================
...
-- Vérification : Lister quelques cours par catégorie avec leurs nouvelles images
SELECT 
  category,
  title,
  thumbnail_url,
