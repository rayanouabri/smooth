...
(
  ...
  'Guide complet Campus France : création de compte, panier de formations, dossier, entretien. Réussissez votre visa !',
...
(
  ...
  'Validez votre VLS-TS sur l''ANEF en 3 mois ! Guide pas à pas : compte, timbre fiscal, attestation. Sécurisez votre séjour.',
  'integration_administrative',
  'debutant',
  'fr',
  3,
...
(
  ...
  'Renouveler votre titre de séjour en France : délais, documents, rendez-vous préfecture, récépissé. Guide essentiel !',
  'integration_administrative',
  'intermediaire',
  'fr',
  6,
...
(
  ...
  'Liste ultime des documents pour la préfecture : domicile, ressources, photos. Évitez le refus, soyez prêt !',
  'integration_administrative',
  'intermediaire',
  'fr',
  5,
